...
public class ConnectionUtilsTest {
    ...
    public void testCheckGeneralJdbcJarFilePathDriverClassNameCase1() {
        ...
        String driverName = "mysql-connector-java-5.1.22-bin.jar"; //$NON-NLS-1$
        CopyTheJarFile();
    ...
    public void testCheckGeneralJdbcJarFilePathDriverClassNameCase4() {
        String driverClass = "om.mysql.jdbc.Driver"; //$NON-NLS-1$
        String driverName = "mysql-connector-java-5.1.22-bin111111.jar"; //$NON-NLS-1$
        CopyTheJarFile();
    ...
    private void CopyTheJarFile() {
        try {
            ...
            try {
                URL resource =
                        CWMPlugin
                                .getDefault()
                                .getBundle()
                                .getResource("jdbc" + Path.SEPARATOR + "mysql-connector-java-5.1.22-bin.jar"); //$NON-NLS-1$ //$NON-NLS-2$
            ...
            File targetFile = new File(tempLibPath + "mysql-connector-java-5.1.22-bin.jar"); //$NON-NLS-1$
